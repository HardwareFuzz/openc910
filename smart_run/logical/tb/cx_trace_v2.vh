...
wire cx_h1_alloc0 = (cx_trace_harts > 1)
    && `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_ctrl.idu_rtu_rob_create0_en;
wire cx_h1_alloc1 = (cx_trace_harts > 1)
    && `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_ctrl.idu_rtu_rob_create1_en;
wire cx_h1_alloc2 = (cx_trace_harts > 1)
    && `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_ctrl.idu_rtu_rob_create2_en;
wire cx_h1_alloc3 = (cx_trace_harts > 1)
    && `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_ctrl.idu_rtu_rob_create3_en;

wire [6:0] cx_h1_alloc0_iid =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.rtu_idu_rob_inst0_iid;
wire [6:0] cx_h1_alloc1_iid =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.rtu_idu_rob_inst1_iid;
wire [6:0] cx_h1_alloc2_iid =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.rtu_idu_rob_inst2_iid;
wire [6:0] cx_h1_alloc3_iid =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.rtu_idu_rob_inst3_iid;

wire [1:0] cx_h1_alloc0_sel =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.ctrl_dp_is_dis_rob_create0_sel;
wire [2:0] cx_h1_alloc1_sel =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.ctrl_dp_is_dis_rob_create1_sel;
wire [1:0] cx_h1_alloc2_sel =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.ctrl_dp_is_dis_rob_create2_sel;

wire [31:0] cx_h1_alloc0_insn =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.is_inst0_read_data[31:0];
wire [31:0] cx_h1_alloc1_insn =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.is_inst1_read_data[31:0];
wire [31:0] cx_h1_alloc2_insn =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.is_inst2_read_data[31:0];
wire [31:0] cx_h1_alloc3_insn =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.is_inst3_read_data[31:0];
wire [2:0] cx_h1_alloc0_len =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.is_inst0_read_data[203] ? 3'd4 : 3'd2;
wire [2:0] cx_h1_alloc1_len =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.is_inst1_read_data[203] ? 3'd4 : 3'd2;
wire [2:0] cx_h1_alloc2_len =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.is_inst2_read_data[203] ? 3'd4 : 3'd2;
wire [2:0] cx_h1_alloc3_len =
    `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.is_inst3_read_data[203] ? 3'd4 : 3'd2;
...
wire [2:0] cx_h0_alloc3_num = cx_h0_alloc3
    ...
    : 3'd0;
wire [2:0] cx_h1_alloc0_num = cx_h1_alloc0
    ? {1'b0, `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.idu_rtu_rob_create0_data[18:17]}
    : 3'd0;
wire [2:0] cx_h1_alloc1_num = cx_h1_alloc1
    ? {1'b0, `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.idu_rtu_rob_create1_data[18:17]}
    : 3'd0;
wire [2:0] cx_h1_alloc2_num = cx_h1_alloc2
    ? {1'b0, `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.idu_rtu_rob_create2_data[18:17]}
    : 3'd0;
wire [2:0] cx_h1_alloc3_num = cx_h1_alloc3
    ? {1'b0, `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.idu_rtu_rob_create3_data[18:17]}
    : 3'd0;
...
wire [2:0] cx_h0_retire2_num = `tb_retire2
    ...
    : 3'd0;
wire [2:0] cx_h1_retire0_num = (cx_trace_harts > 1 && `tb_core1_retire0)
    ? {1'b0, `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.x_ct_rtu_rob.x_ct_rtu_rob_rt.retire_inst0_num}
    : 3'd0;
wire [2:0] cx_h1_retire1_num = (cx_trace_harts > 1 && `tb_core1_retire1)
    ? {1'b0, `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.x_ct_rtu_rob.x_ct_rtu_rob_rt.retire_inst1_num}
    : 3'd0;
wire [2:0] cx_h1_retire2_num = (cx_trace_harts > 1 && `tb_core1_retire2)
    ? {1'b0, `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.x_ct_rtu_rob.x_ct_rtu_rob_rt.retire_inst2_num}
    : 3'd0;
...
wire cx_h1_retire0_split = (cx_trace_harts > 1 && `tb_core1_retire0)
    && cx_h1_valid[`CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_commit0_iid[5:0]]
    && cx_h1_split[`CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_commit0_iid[5:0]];
wire cx_h1_retire1_split = (cx_trace_harts > 1 && `tb_core1_retire1)
    && cx_h1_valid[`CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_commit1_iid[5:0]]
    && cx_h1_split[`CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_commit1_iid[5:0]];
wire cx_h1_retire2_split = (cx_trace_harts > 1 && `tb_core1_retire2)
    && cx_h1_valid[`CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_commit2_iid[5:0]]
    && cx_h1_split[`CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_commit2_iid[5:0]];
...
wire cx_h1_trap0 = (cx_trace_harts > 1) && `tb_core1_retire0
    && `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_cp0_expt_vld
    && !`CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_cp0_int_ack;
...
function cx_h1_index_released;
  input [5:0] idx;
  begin
    cx_h1_index_released =
      (`tb_core1_retire0 &&
       `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_commit0_iid[5:0] == idx)
      || (`tb_core1_retire1 &&
       `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_commit1_iid[5:0] == idx)
      || (`tb_core1_retire2 &&
       `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_commit2_iid[5:0] == idx);
  end
endfunction
...
always @(posedge `CPU_CLK or negedge `CPU_RST) begin
  if(!`CPU_RST) begin
    ...
    if(cx_trace_harts > 1 && `tb_core1_retire0)
      cx_trace_terminal(1, 0,
        `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_commit0_iid,
        `core1_retire0_pc, cx_h1_retire0_num,
        cx_h1_term_seq, cx_h1_instret_seq, cx_h1_trap0,
        `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_expt_vec,
        `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_cp0_top.cp0_yy_priv_mode);
    if(cx_trace_harts > 1 && `tb_core1_retire1)
      cx_trace_terminal(1, cx_h1_retire0_arch_num,
        `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_commit1_iid,
        `core1_retire1_pc, cx_h1_retire1_num,
        cx_h1_term_seq + cx_h1_retire0_arch_num,
        cx_h1_instret_seq + cx_h1_retire0_arch_num - cx_h1_trap0,
        1'b0, 6'd0,
        `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_cp0_top.cp0_yy_priv_mode);
    if(cx_trace_harts > 1 && `tb_core1_retire2)
      cx_trace_terminal(1, cx_h1_retire0_arch_num + cx_h1_retire1_arch_num,
        `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_commit2_iid,
        `core1_retire2_pc, cx_h1_retire2_num,
        cx_h1_term_seq + cx_h1_retire0_arch_num + cx_h1_retire1_arch_num,
        cx_h1_instret_seq + cx_h1_retire0_arch_num - cx_h1_trap0
                              + cx_h1_retire1_arch_num,
        1'b0, 6'd0,
        `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_cp0_top.cp0_yy_priv_mode);
    cx_h1_term_seq <= cx_h1_term_seq + cx_h1_terminal_count;
    cx_h1_instret_seq <= cx_h1_instret_seq + cx_h1_retired_count;
    ...
    if(cx_trace_harts > 1
       ...
       && cx_trace_file != 0)
      $fwrite(cx_trace_file,
        "CXTRACE v=2 event=interrupt core=openc910 hart=1 cycle=%0d cause=%0d priv=%0d\n",
        cx_trace_now,
        `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_expt_vec,
        `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_cp0_top.cp0_yy_priv_mode);
    ...
    if(`CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_flush) begin
      cx_h1_split_pending = 1'b0;
      for(cx_trace_i = 0; cx_trace_i < 64; cx_trace_i = cx_trace_i + 1)
        cx_h1_valid[cx_trace_i] <= 1'b0;
    end
    ...
    if(!`CPU_TOP.x_ct_top_1.x_ct_core.x_ct_rtu_top.rtu_yy_xx_flush) begin
      if(cx_h1_alloc0) begin
        cx_h1_split[cx_h1_alloc0_iid[5:0]] <=
          `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.idu_rtu_rob_create0_data[7];
        case(cx_h1_alloc0_sel)
          0: cx_trace_allocate(1, cx_h1_alloc0_iid, cx_h1_alloc0_num,
               cx_h1_next_token, cx_h1_alloc0_insn, cx_h1_alloc0_len,
               32'd0, 3'd0, 32'd0, 3'd0);
          1: cx_trace_allocate(1, cx_h1_alloc0_iid, cx_h1_alloc0_num,
               cx_h1_next_token, cx_h1_alloc0_insn, cx_h1_alloc0_len,
               cx_h1_alloc1_insn, cx_h1_alloc1_len, 32'd0, 3'd0);
          2: cx_trace_allocate(1, cx_h1_alloc0_iid, cx_h1_alloc0_num,
               cx_h1_next_token, cx_h1_alloc0_insn, cx_h1_alloc0_len,
               cx_h1_alloc1_insn, cx_h1_alloc1_len,
               cx_h1_alloc2_insn, cx_h1_alloc2_len);
          default: $error("OpenC910 CX Trace V2 invalid create0 select: hart=1 sel=%0d cycle=%0d",
                          cx_h1_alloc0_sel, cx_trace_now);
        endcase
      end
      if(cx_h1_alloc1) begin
        cx_h1_split[cx_h1_alloc1_iid[5:0]] <=
          `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.idu_rtu_rob_create1_data[7];
        case(cx_h1_alloc1_sel)
          0: cx_trace_allocate(1, cx_h1_alloc1_iid, cx_h1_alloc1_num,
               cx_h1_next_token + cx_h1_alloc0_num,
               cx_h1_alloc1_insn, cx_h1_alloc1_len,
               32'd0, 3'd0, 32'd0, 3'd0);
          1: cx_trace_allocate(1, cx_h1_alloc1_iid, cx_h1_alloc1_num,
               cx_h1_next_token + cx_h1_alloc0_num,
               cx_h1_alloc1_insn, cx_h1_alloc1_len,
               cx_h1_alloc2_insn, cx_h1_alloc2_len, 32'd0, 3'd0);
          2: cx_trace_allocate(1, cx_h1_alloc1_iid, cx_h1_alloc1_num,
               cx_h1_next_token + cx_h1_alloc0_num,
               cx_h1_alloc2_insn, cx_h1_alloc2_len,
               32'd0, 3'd0, 32'd0, 3'd0);
          3: cx_trace_allocate(1, cx_h1_alloc1_iid, cx_h1_alloc1_num,
               cx_h1_next_token + cx_h1_alloc0_num,
               cx_h1_alloc3_insn, cx_h1_alloc3_len,
               32'd0, 3'd0, 32'd0, 3'd0);
          4: cx_trace_allocate(1, cx_h1_alloc1_iid, cx_h1_alloc1_num,
               cx_h1_next_token + cx_h1_alloc0_num,
               cx_h1_alloc1_insn, cx_h1_alloc1_len,
               cx_h1_alloc2_insn, cx_h1_alloc2_len,
               cx_h1_alloc3_insn, cx_h1_alloc3_len);
          default: $error("OpenC910 CX Trace V2 invalid create1 select: hart=1 sel=%0d cycle=%0d",
                          cx_h1_alloc1_sel, cx_trace_now);
        endcase
      end
      if(cx_h1_alloc2) begin
        cx_h1_split[cx_h1_alloc2_iid[5:0]] <=
          `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.idu_rtu_rob_create2_data[7];
        case(cx_h1_alloc2_sel)
          0: cx_trace_allocate(1, cx_h1_alloc2_iid, cx_h1_alloc2_num,
               cx_h1_next_token + cx_h1_alloc0_num + cx_h1_alloc1_num,
               cx_h1_alloc2_insn, cx_h1_alloc2_len,
               32'd0, 3'd0, 32'd0, 3'd0);
          2: cx_trace_allocate(1, cx_h1_alloc2_iid, cx_h1_alloc2_num,
               cx_h1_next_token + cx_h1_alloc0_num + cx_h1_alloc1_num,
               cx_h1_alloc2_insn, cx_h1_alloc2_len,
               cx_h1_alloc3_insn, cx_h1_alloc3_len, 32'd0, 3'd0);
          3: cx_trace_allocate(1, cx_h1_alloc2_iid, cx_h1_alloc2_num,
               cx_h1_next_token + cx_h1_alloc0_num + cx_h1_alloc1_num,
               cx_h1_alloc3_insn, cx_h1_alloc3_len,
               32'd0, 3'd0, 32'd0, 3'd0);
          default: $error("OpenC910 CX Trace V2 invalid create2 select: hart=1 sel=%0d cycle=%0d",
                          cx_h1_alloc2_sel, cx_trace_now);
        endcase
      end
      if(cx_h1_alloc3) begin
        cx_h1_split[cx_h1_alloc3_iid[5:0]] <=
          `CPU_TOP.x_ct_top_1.x_ct_core.x_ct_idu_top.x_ct_idu_is_dp.idu_rtu_rob_create3_data[7];
        cx_trace_allocate(1, cx_h1_alloc3_iid, cx_h1_alloc3_num,
          cx_h1_next_token + cx_h1_alloc0_num + cx_h1_alloc1_num
            + cx_h1_alloc2_num,
          cx_h1_alloc3_insn, cx_h1_alloc3_len,
          32'd0, 3'd0, 32'd0, 3'd0);
      end
      cx_h1_next_token <= cx_h1_next_token + cx_h1_alloc_count;
    end
