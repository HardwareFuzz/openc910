...
`define tb_core1_retire0    tb.x_soc.x_cpu_sub_system_axi.core1_pad_retire0
`define core1_retire0_pc    tb.x_soc.x_cpu_sub_system_axi.core1_pad_retire0_pc[39:0]
`define tb_core1_retire1    tb.x_soc.x_cpu_sub_system_axi.core1_pad_retire1
`define core1_retire1_pc    tb.x_soc.x_cpu_sub_system_axi.core1_pad_retire1_pc[39:0]
`define tb_core1_retire2    tb.x_soc.x_cpu_sub_system_axi.core1_pad_retire2
`define core1_retire2_pc    tb.x_soc.x_cpu_sub_system_axi.core1_pad_retire2_pc[39:0]
  ...
  begin
    if(cx_trace_file != 0) begin
      ...
      if(`tb_retire0 || `tb_retire1 || `tb_retire2 ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_rtu_top.idu_rtu_pst_dis_inst0_preg_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_rtu_top.idu_rtu_pst_dis_inst1_preg_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_rtu_top.idu_rtu_pst_dis_inst2_preg_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_rtu_top.idu_rtu_pst_dis_inst3_preg_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_rtu_top.idu_rtu_pst_dis_inst0_freg_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_rtu_top.idu_rtu_pst_dis_inst1_freg_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_rtu_top.idu_rtu_pst_dis_inst2_freg_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_rtu_top.idu_rtu_pst_dis_inst3_freg_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_iu_top.x_ct_iu_rbus.iu_idu_ex2_pipe0_wb_preg_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_iu_top.x_ct_iu_rbus.iu_idu_ex2_pipe1_wb_preg_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_lsu_top.x_ct_lsu_ld_wb.lsu_idu_wb_pipe3_wb_preg_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_lsu_top.x_ct_lsu_ld_wb.lsu_idu_wb_pipe3_wb_vreg_fr_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_vfpu_top.x_ct_vfpu_rbus.vfpu_idu_ex5_pipe6_wb_vreg_fr_vld ||
         `CPU_TOP.x_ct_top_0.x_ct_core.x_ct_vfpu_top.x_ct_vfpu_rbus.vfpu_idu_ex5_pipe7_wb_vreg_fr_vld) begin
